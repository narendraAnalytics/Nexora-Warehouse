...
export default function ChennaiPODetailPage() {
  ...
  async function handleCreateGRN() {
    ...
    try {
      ...
      router.push(`/branch/chennai/procurement/grn/${data.id}`)
    } finally {
  ...
  return (
    <div className="nexora-po">
      ...
      <div className="po-topbar">
        ...
        <button
          className="po-back"
          onClick={() => router.push(`/branch/chennai/procurement/pr/${po.pr_id}`)}
          title="Back to PR"
        ...
        <button
          className="po-back"
          onClick={() => router.push("/branch/chennai/dashboard")}
        ...
        <div className="po-side">
          ...
          <div className="po-card">
            ...
            <div style={{ marginTop: 14 }}>
              {existingGrnId ? (
                <button
                  onClick={() => router.push(`/branch/chennai/procurement/grn/${existingGrnId}`)}
                  style={{
