...
// ── Main Component ─────────────────────────────────────────────────────────
export default function ChennaiPRDetailPage() {
  ...
  async function handleGeneratePO() {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        router.push(`/branch/chennai/procurement/po/${data.id}`)
      }
    } catch {
  ...
  return (
    <div className="nexora-pr-detail">
      ...
      <div className="prd-topbar">
        ...
        <button className="prd-back" onClick={() => router.push("/branch/chennai/procurement/pr")} title="Back to PR list" aria-label="Back to PR list">
          ← Back to PRs
        </button>
          ...
          <div className="prd-card">
            ...
            <div className="prd-summary-row" style={{ marginTop: 14 }}>
              ...
              <div className="prd-sum-card">
                ...
                <div className="prd-sum-sub">Chennai branch</div>
              </div>
            </div>
          </div>
          ...
          {pr.status === "APPROVED" && (
            <div className="prd-card">
              ...
              <div style={{ marginTop: 16 }}>
                {existingPoId ? (
                  <button
                    onClick={() => router.push(`/branch/chennai/procurement/po/${existingPoId}`)}
