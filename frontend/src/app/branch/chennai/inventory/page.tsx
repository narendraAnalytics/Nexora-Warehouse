...
const WAREHOUSE_IDS: Record<string, string> = {
  chennai: "2521c486-9c74-49a2-8802-374dcb7d5d5d",
}
...
const MODAL_STEPS = [
  { id:"s1", emoji:"⚡", title:"Frontend Request Sent",    sub:"POST /api/inventory/analyze?branch=chennai",  startMs:0,     doneMs:900,   prog:12,  status:"Sending analysis request…" },
  { id:"s2", emoji:"🔗", title:"Warehouse UUID Resolved",  sub:"Neon DB lookup — 2521c486…5d5d",              startMs:900,   doneMs:2100,  prog:25,  status:"Resolving Chennai warehouse ID…" },
...
const MODAL_LOGS = [
  {ms:0,     cls:"info", txt:"[07:12:43.001] Initiating inventory analysis for Chennai branch…"},
  {ms:150,   cls:"info", txt:"[07:12:43.152] → POST /api/inventory/analyze?branch=chennai"},
  {ms:320,   cls:"dim",  txt:"[07:12:43.320]   Body: {}"},
  {ms:900,   cls:"info", txt:"[07:12:43.900] Next.js API route received request — branch: chennai"},
  {ms:1100,  cls:"sql",  txt:"[07:12:44.100] ⬡ SELECT id FROM warehouses WHERE LOWER(city) = 'chennai' AND is_active = TRUE LIMIT 1"},
  {ms:1550,  cls:"ok",   txt:"[07:12:44.550] ✓ warehouse_id: 2521c486-9c74-49a2-8802-374dcb7d5d5d"},
  ...
  {ms:2350,  cls:"info", txt:"[07:12:45.350] Building task: \"Analyze inventory for warehouse_id=2521c486…\""},
  ...
  {ms:4300,  cls:"tool", txt:"[07:12:47.300] ⚒  Tool selected: get_stock_levels(2521c486…)"},
...
export default function BranchInventoryPage() {
  ...
  const branch = (params?.branch as string) ?? "chennai"
  ...
  const warehouseId = WAREHOUSE_IDS[branch.toLowerCase()] ?? WAREHOUSE_IDS.chennai
    ...
    <div className="nexora-inventory">
        ...
        <div className="ni-topbar">
          <div>
            ...
            <div className="ni-tb-sub">{branchLabel} Central Warehouse · CHN-01</div>
          </div>
        ...
        <div className="ni-action-bar">
          ...
          <div className="ni-action-bar-right">
            ...
            <button
              ...
              onClick={() => {
                sessionStorage.setItem("chn_pr_analysis", JSON.stringify(analysis))
