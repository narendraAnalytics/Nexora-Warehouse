...
// ── Component ─────────────────────────────────────────────────────────────────
export default function ChennaiDashboard() {
  ...
  useEffect(() => {
    Promise.all([
      fetch("/api/branch/chennai/kpis").then(r => r.json()),
      fetch("/api/branch/chennai/orders-trend").then(r => r.json()),
      fetch("/api/branch/chennai/inventory-categories").then(r => r.json()),
      fetch("/api/dashboard/alerts").then(r => r.json()),
      fetch("/api/procurement/pr?warehouse_id=2521c486-9c74-49a2-8802-374dcb7d5d5d").then(r => r.json()).catch(() => []),
    ]).then(([k, o, c, a, p]) => {
      setKpis(k)
      ...
      <aside className="bd-sb">
        <div className="bd-sb-logo">
          <svg className="bd-sb-lm" viewBox="0 0 34 34" fill="none">
            <defs>
              <linearGradient id="csg1" x1="0" y1="0" x2="34" y2="34"><stop offset="0%" stopColor="#FF8C00"/><stop offset="100%" stopColor="#FFD700"/></linearGradient>
              <linearGradient id="csg2" x1="3" y1="12" x2="22" y2="31"><stop offset="0%" stopColor="#FF4FA3"/><stop offset="50%" stopColor="#3EE8C2"/><stop offset="100%" stopColor="#7C3AED"/></linearGradient>
            </defs>
            <path d="M17 1.5L32.5 13V32.5H1.5V13Z" fill="white" stroke="url(#csg1)" strokeWidth="2" strokeLinejoin="round"/>
            <rect x="3" y="13" width="7" height="18" rx="1.2" fill="url(#csg2)"/>
            <polygon points="10,13 15,13 21,31 16,31" fill="url(#csg2)"/>
            <rect x="13" y="13" width="7" height="18" rx="1.2" fill="url(#csg2)"/>
        ...
        <nav className="bd-sb-nav">
          {[
            ...
            { label: "Inventory",              active: false, badge: null, href: "/branch/chennai/inventory",
            ...
            { label: "Procurement",            active: false, badge: null, href: "/branch/chennai/procurement/pr",
        ...
        <div className="bd-sb-ai">
          ...
          <div className="bd-ai-copy">Need insights or help? Ask me anything about Chennai branch operations.</div>
        ...
        <div className="bd-topbar">
          <div className="bd-tb-left">
            <svg className="bd-tb-lm" viewBox="0 0 34 34" fill="none">
              <defs>
                <linearGradient id="ctbg1" x1="0" y1="0" x2="34" y2="34"><stop offset="0%" stopColor="#FF8C00"/><stop offset="100%" stopColor="#FFD700"/></linearGradient>
                <linearGradient id="ctbg2" x1="3" y1="12" x2="22" y2="31"><stop offset="0%" stopColor="#FF4FA3"/><stop offset="50%" stopColor="#3EE8C2"/><stop offset="100%" stopColor="#7C3AED"/></linearGradient>
              </defs>
              <path d="M17 1.5L32.5 13V32.5H1.5V13Z" fill="white" stroke="url(#ctbg1)" strokeWidth="2" strokeLinejoin="round"/>
              <rect x="3" y="13" width="7" height="18" rx="1.2" fill="url(#ctbg2)"/>
              <polygon points="10,13 15,13 21,31 16,31" fill="url(#ctbg2)"/>
              <rect x="13" y="13" width="7" height="18" rx="1.2" fill="url(#ctbg2)"/>
              <rect x="22" y="13" width="1.5" height="18" rx=".8" fill="#ddd"/>
              <rect x="30" y="13" width="1.5" height="18" rx=".8" fill="#ddd"/>
              <rect x="22" y="13" width="9.5" height="6" rx="1.5" fill="#FF6B35" opacity=".9"/>
              <rect x="22" y="21" width="9.5" height="5" rx="1.5" fill="#3EE8C2" opacity=".9"/>
            ...
            <div className="bd-tb-title-block">
              ...
              <div className="bd-tb-sub">Chennai Central Warehouse (CHN-01)</div>
            </div>
          </div>
          ...
          <div className="bd-tb-right">
            ...
            <div className="bd-tb-user">
              <div className="bd-tb-avatar">S</div>
              <div>
                <div className="bd-tb-uname">Suresh Rajan</div>
          ...
          <div className="bd-right">
            ...
            <div className="bd-ceo-card">
              ...
              <p className="bd-ceo-quote">
                &ldquo;Chennai is a strategic gateway to South India. Build the inventory base here aggressively — let&apos;s make it our next high-throughput hub.&rdquo;
              </p>
            </div>
            ...
            <div className="bd-card bd-pr-status-card">
              <div className="bd-ch">
                ...
                <button className="bd-clink" onClick={() => router.push("/branch/chennai/procurement/pr")}>New PR →</button>
              </div>
              {loading ? (
                <><Skel h={38}/><Skel h={38}/></>
              ) : prs.length === 0 ? (
                ...
                prs.map(pr => {
                  ...
                  return (
                    <div key={pr.id} className="bd-pr-row" onClick={() => router.push(`/branch/chennai/procurement/pr/${pr.id}`)}>
            ...
            <div className="bd-qa-card">
              ...
              <button className="bd-qa-btn procurement" onClick={() => router.push("/branch/chennai/procurement/pr")}>
                <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round">
