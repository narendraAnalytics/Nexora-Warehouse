      ...
      <aside className="bd-sb">
        ...
        <nav className="bd-sb-nav">
          {[
            ...
            { label: "Orders",                 active: false, badge: null,
            ...
            { label: "Shipments",              active: false, badge: null,
            ...
            { label: "Alerts & Notifications", active: false, badge: alerts.length > 0 ? String(alerts.length) : null,
            ...
            <a key={item.label} className={`bd-nav-a${item.active ? " on" : ""}`}>
              {item.icon}
              {item.label}
